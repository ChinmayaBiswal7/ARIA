...
class MiniGPT(nn.Module):
    """ A tiny character-level GPT Language Model """
    ...
    def forward(self, idx, targets=None):
        ...
        # Keep context within context length
    ...
    def generate(self, idx, max_new_tokens, temperature=1.0, top_k=None):
        """ Generate text given a starting sequence context """
        for _ in range(max_new_tokens):
            ...
            # Optionally filter to top k choices
